/* Armstrong sayi = Tum basamaklarindaki rakamlarin sayi degerlerinin kupleri toplami,
kendisine esit olan sayilara "Armstrong sayi" denir. */
...
int main()
{
   int x,a,b,c,d,e;
	...
	baslangic:
	printf("Armstrong sayi (100-999 arasi degerler)\n");
